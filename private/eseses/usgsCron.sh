...
python earthquake_reducer.py ~/ESESES/Missions/ESESES/Layers/RecentM2M3.json
python earthquake_reducer.py ~/ESESES/Missions/ESESES/Layers/RecentM3M6.json
python earthquake_reducer.py ~/ESESES/Missions/ESESES/Layers/RecentSignificant.json
python earthquake_reducer.py ~/ESESES/Missions/ESESES/Layers/HistoricalSignificant.json