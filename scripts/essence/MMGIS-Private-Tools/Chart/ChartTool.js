...
define(  [ 'jquery', 'd3', 'Formulae_', 'Layers_', 'Map_', 'Viewer_', 'highcharts', 'highcharts/modules/exporting', 'highcharts/modules/export-data', 'highcharts/modules/series-label', 'highcharts/modules/offline-exporting', 'highcharts/modules/jspdf', 'highcharts/modules/svg2pdf', 'highcharts/modules/boost'],
function (    $    ,  d3 ,      F_    ,     L_   ,  Map_ ,  Viewer_, Highcharts, f, c, g, b, jsPDF, svg2pdf ) {
  ...
  if (window.innerHeight < 1255) {
    ...
    toolHeight = 1200; //recommended min height to avoid scrolling
  }
    ...
    make: function() {
      ...
      var chartOptions = ['<a href="#" style="float:left;display:none;" id="showInfo">&#187; Show Site Info</a>',
        ...
        '<select id="selectSource" style="color:black">',
            ...
            '<option selected="selected" value="combg">CombinationG</option>',
